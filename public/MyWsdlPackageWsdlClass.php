<?php
/**
 * File for MyWsdlPackageWsdlClass to communicate with SOAP service
 ...
 */
/**
 * MyWsdlPackageWsdlClass to communicate with SOAP service
 * 
 * @package MyWsdlPackage
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2017-11-08
 */
class MyWsdlPackageWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'var/wsdltophp.com/storage/wsdls/0eb1e771810808d4f6a04a8020c221fe/wsdl.xml';
    /**
    ...
    /**
     * Constructor
     * @uses MyWsdlPackageWsdlClass::setLastError()
     * @uses MyWsdlPackageWsdlClass::initSoapClient()
     * @uses MyWsdlPackageWsdlClass::initInternArrayToIterate()
     * @uses MyWsdlPackageWsdlClass::_set()
     ...
     * @return MyWsdlPackageWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'MyWsdlPackageWsdlClass'))
            {
     ...
     * @uses MyWsdlPackageClassMap::classMap()
     * @uses MyWsdlPackageWsdlClass::getDefaultWsdlOptions()
     * @uses MyWsdlPackageWsdlClass::getSoapClientClassName()
     * @uses MyWsdlPackageWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('MyWsdlPackageClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = MyWsdlPackageClassMap::classMap();
     ...
     * If a class is named as {MyWsdlPackage}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('MyWsdlPackageSoapClient') && is_subclass_of('MyWsdlPackageSoapClient','SoapClient'))
            return 'MyWsdlPackageSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses MyWsdlPackageWsdlClass::WSDL_CACHE_WSDL
     * @uses MyWsdlPackageWsdlClass::WSDL_COMPRESSION
     * @uses MyWsdlPackageWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses MyWsdlPackageWsdlClass::WSDL_ENCODING
     * @uses MyWsdlPackageWsdlClass::WSDL_EXCEPTIONS
     * @uses MyWsdlPackageWsdlClass::WSDL_FEATURES
     * @uses MyWsdlPackageWsdlClass::WSDL_LOGIN
     * @uses MyWsdlPackageWsdlClass::WSDL_PASSWORD
     * @uses MyWsdlPackageWsdlClass::WSDL_SOAP_VERSION
     * @uses MyWsdlPackageWsdlClass::WSDL_STREAM_CONTEXT
     * @uses MyWsdlPackageWsdlClass::WSDL_TRACE
     * @uses MyWsdlPackageWsdlClass::WSDL_TYPEMAP
     * @uses MyWsdlPackageWsdlClass::WSDL_URL
     * @uses MyWsdlPackageWsdlClass::VALUE_WSDL_URL
     * @uses MyWsdlPackageWsdlClass::WSDL_USER_AGENT
     * @uses MyWsdlPackageWsdlClass::WSDL_PROXY_HOST
     * @uses MyWsdlPackageWsdlClass::WSDL_PROXY_PORT
     * @uses MyWsdlPackageWsdlClass::WSDL_PROXY_LOGIN
     * @uses MyWsdlPackageWsdlClass::WSDL_PROXY_PASSWORD
     * @uses MyWsdlPackageWsdlClass::WSDL_LOCAL_CERT
     * @uses MyWsdlPackageWsdlClass::WSDL_PASSPHRASE
     * @uses MyWsdlPackageWsdlClass::WSDL_AUTHENTICATION
     * @uses MyWsdlPackageWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses MyWsdlPackageWsdlClass::getSoapClient()
     * @uses MyWsdlPackageWsdlClass::getFormatedXml()
     ...
     * @uses MyWsdlPackageWsdlClass::getSoapClient()
     * @uses MyWsdlPackageWsdlClass::convertStringHeadersToArray()
     ...
     * @uses MyWsdlPackageWsdlClass::count()
     * @return int
     */
     ...
     * @uses MyWsdlPackageWsdlClass::getInternArrayToIterate()
     * @uses MyWsdlPackageWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses MyWsdlPackageWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses MyWsdlPackageWsdlClass::getInternArrayToIterateOffset()
     * @uses MyWsdlPackageWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses MyWsdlPackageWsdlClass::getInternArrayToIterateOffset()
     * @uses MyWsdlPackageWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see MyWsdlPackageWsdlClass::offsetGet()
     * @uses MyWsdlPackageWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses MyWsdlPackageWsdlClass::getAttributeName()
     * @uses MyWsdlPackageWsdlClass::__toString()
     * @uses MyWsdlPackageWsdlClass::_set()
     * @uses MyWsdlPackageWsdlClass::_get()
     * @uses MyWsdlPackageWsdlClass::setInternArrayToIterate()
     * @uses MyWsdlPackageWsdlClass::setInternArrayToIterateIsArray()
     * @uses MyWsdlPackageWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses MyWsdlPackageWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses MyWsdlPackageWsdlClass::item()
     * @uses MyWsdlPackageWsdlClass::length()
     * @return mixed
     */
