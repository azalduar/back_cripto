...
! function(t) {
    ...
    var ve = jt.DayTableMixin = {
            ...
            renderHeadDateCellHtml: function(t, e, n) {
                var i = this.view;
                return '<th class="fc-day-header ' + i.widgetHeaderClass + " fc-" + $t[t.day()] + '"' + (1 === this.rowCnt ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") + (e > 1 ? ' colspan="' + e + '"' : "") + (n ? " " + n : "") + "><div class='day-header'>" + i.buildGotoAnchorHtml({
                    date: t,
                    forceOff: this.rowCnt > 1 || 1 === this.colCnt
                }, tt(t.format(this.colHeadFormat))) + "</div></th>"
            },
    ...
    me.mixin({
        ...
        fgSegHtml: function(t, e) {
            var n, i, r = this.view,
                ...
                c = "";
            return u.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getEventTimeText(s), n && (c = '<span class="fc-time">' + tt(n) + "</span>")), i = '<div class="fc-title">' + (tt(s.title || "") || "&nbsp;") + "</div>", '<a class="' + u.join(" ") + '"' + (s.url ? ' href="' + tt(s.url) + '"' : "") + (d ? ' style="' + d + '"' : "") + '><div class="fc-content">' + (this.isRTL ? i + " " + c : c + " " + i) + "</div>" + (l ? '<div class="fc-resizer fc-start-resizer" />' : "") + (a ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        },
            ...
            for (r = 0; r < f; r++) {
                if (s = h[r], o = 0, l = t("<tr/>"), p.push([]), v.push([]), m.push([]), s)
                    for (a = 0; a < s.length; a++) {
                        for (u = s[a], i(u.leftCol), d = t('<td class="fc-event-container"/><div>dfgdg</div>').append(u.el), u.leftCol != u.rightCol ? d.attr("colspan", u.rightCol - u.leftCol + 1) : m[r][o] = d; o <= u.rightCol;) v[r][o] = d, p[r][o] = u, o++;
                        l.append(d)
                    }
    ...
    var Ge = Se.extend({
        ...
        Ae = pe.extend({
            ...
            dayHeaderHtml: function(t) {
                ...
                return '<tr class="fc-list-heading" data-date="' + t.format("YYYY-MM-DD") + '"><td class="' + e.widgetHeaderClass + '" colspan="3"><div class="fecha_header"></div' + (n ? e.buildGotoAnchorHtml(t, {
                    class: "fc-list-heading-main"
                }, tt(t.format('ddd DD'))) : "") + (i ? e.buildGotoAnchorHtml(t, {
                    class: "fc-list-heading-alt"
                }, tt(t.format('ddd DD'))) : "") + "</td></tr>"
            },
            fgSegHtml: function(t) {
                var e, n = this.view,
                    ...
                    s = t.event,
                    o = s.url;
                return e = s.allDay ? n.getAllDayHtml() : n.isMultiDayEvent(s) ? t.isStart || t.isEnd ? tt(this.getEventTimeText(t)) : n.getAllDayHtml() : tt(this.getEventTimeText(s)), o && i.push("fc-has-url"), '<tr class="' + i.join(" ") + '">' + (this.displayEventTime ? '<td class="fc-list-item-time ' + n.widgetContentClass + '">' + (e || "") + "</td>" : "") + '<td class="fc-list-item-marker ' + n.widgetContentClass + '"><span class="fc-event-dot"' + (r ? ' style="background-color:' + r + '"' : "") + '></span></td><td class="' + n.widgetContentClass + '"><div class="lista-eventos"><div class="fc-list-item-title"><a' + (o ? ' href="' + tt(o) + '"' : "") + ">" + tt(t.event.title || "") + "</a></div></div></td></tr>"
            }
        });
    return Ut.list = {
        class: Ge,
