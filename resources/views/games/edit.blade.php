...
@section('main-content')
    ...
    <div class="row">
        ...
        <form action="{{url('games/'.$game->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12">@include('HTML.image_upload', ['input' => ['name'=>'image']])</div>
            <div class="col-md-12">@include('HTML.select_simple', ['input' => ['name'=>'rating_id', 'options'=>$ratings]])</div>
            <div class="col-md-6">@include('HTML.select_multi', ['input' => ['name'=>'categories','options'=>$categories]])</div>
            <div class="col-md-6">@include('HTML.select_multi', ['input' => ['name'=>'platforms', 'options'=>$platforms]])</div>
            

            <div class="col-md-12"><button type="submit" class="btn btn-primary">{{trans('message.save')}}</button></div>
        </form>
