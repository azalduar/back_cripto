...
<?php echo "@section('main-content')\n"; ?>
    ...
    <div class="row">
        ...
        <form action="<?php echo "{{url('".$view['plural_name']."')}}";?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12"><button type="submit" class="btn btn-primary"><?php echo "{{trans('message.create')}}";?></button></div>
        </form>
