...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="">PerfilesApp</a>.</strong>{{-- {{ trans('adminlte_lang::message.createdby') }} <a href="http://acacha.org/sergitur">Sergi Tur Badenas</a>. {{ trans('adminlte_lang::message.seecode') }} <a href="https://github.com/acacha/adminlte-laravel">Github</a> --}}
</footer>