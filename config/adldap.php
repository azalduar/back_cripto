            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', '192.168.99.101')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'ou=Shop,dc=arqsof,dc=unal,dc=edu,dc=co'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'cn=admin,dc=arqsoft,dc=unal,dc=edu,dc=co'),
